...
type ConfigSyncLocalDatabaseRowApiService service
/*
ConfigSyncLocalDatabaseRowApiService Get a Config Sync Local Database object.
 ...
 * @param type_ The type of the row. Can be one of \&quot;router\&quot; or \&quot;vpn\&quot;. There is one \&quot;router\&quot; row and one row for each configured \&quot;vpn\&quot;. Each row represents a table of information that is synchronized between Config Sync and replication mates.
 * @param name The name is \&quot;site\&quot; when the row type is \&quot;router\&quot;, otherwise it is the Message VPN name.
 * @param optional nil or *ConfigSyncLocalDatabaseRowApiGetConfigSyncLocalDatabaseRowOpts - Optional Parameters:
...
@return ConfigSyncLocalDatabaseRowResponse
*/

type ConfigSyncLocalDatabaseRowApiGetConfigSyncLocalDatabaseRowOpts struct {
    Select_ optional.Interface
}

func (a *ConfigSyncLocalDatabaseRowApiService) GetConfigSyncLocalDatabaseRow(ctx context.Context, type_ string, name string, localVarOptionals *ConfigSyncLocalDatabaseRowApiGetConfigSyncLocalDatabaseRowOpts) (ConfigSyncLocalDatabaseRowResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ConfigSyncLocalDatabaseRowResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/configSyncLocalDatabaseRows/{type},{name}"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ConfigSyncLocalDatabaseRowResponse
...
/*
ConfigSyncLocalDatabaseRowApiService Get a list of Config Sync Local Database objects.
Get a list of Config Sync Local Database objects.  Config Sync Local Database Rows contains information about the status of the table for this Broker or a local Message VPN.   Attribute|Identifying|Deprecated :---|:---:|:---: name|x| type|x|    A SEMP client authorized with a minimum access scope/level of \&quot;global/none\&quot; is required to perform this operation.  This has been available since 2.22.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ConfigSyncLocalDatabaseRowApiGetConfigSyncLocalDatabaseRowsOpts - Optional Parameters:
     ...
     * @param "Select_" (optional.Interface of []string) -  Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See the documentation for the &#x60;select&#x60; parameter.
@return ConfigSyncLocalDatabaseRowsResponse
*/

type ConfigSyncLocalDatabaseRowApiGetConfigSyncLocalDatabaseRowsOpts struct {
...
func (a *ConfigSyncLocalDatabaseRowApiService) GetConfigSyncLocalDatabaseRows(ctx context.Context, localVarOptionals *ConfigSyncLocalDatabaseRowApiGetConfigSyncLocalDatabaseRowsOpts) (ConfigSyncLocalDatabaseRowsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ConfigSyncLocalDatabaseRowsResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/configSyncLocalDatabaseRows"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ConfigSyncLocalDatabaseRowsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
