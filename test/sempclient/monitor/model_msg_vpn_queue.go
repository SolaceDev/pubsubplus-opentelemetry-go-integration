...
type MsgVpnQueue struct {
	...
	AverageBindRequestRate int64 `json:"averageBindRequestRate,omitempty"`
	...
	BindRequestRate int64 `json:"bindRequestRate,omitempty"`
	...
	// The name of the client assigned to the partition if the client is currently bound to the queue. Only relevant for queues implementing an individual partition. Available since (will be released in next SEMP version).
	PartitionClientName string `json:"partitionClientName,omitempty"`
	// The count of partitions of the queue. Only relevant for queues with an access type of non-exclusive. When zero, bound clients receive messages round-robin. Otherwise, bound clients receive messages from individually assigned partitions. Available since (will be released in next SEMP version).
	PartitionCount int32 `json:"partitionCount,omitempty"`
	// The partition number. Only relevant for queues implementing an individual partition. Available since (will be released in next SEMP version).
	PartitionNumber int32 `json:"partitionNumber,omitempty"`
	// The operational count of partitions of the queue. Only relevant for queues with an access type of non-exclusive. This may not match the configured count while scaling is underway. Available since (will be released in next SEMP version).
	PartitionOperationalCount int32 `json:"partitionOperationalCount,omitempty"`
	// The name of our partitioned queue. Only relevant for queues implementing an individual partition. Available since (will be released in next SEMP version).
	PartitionQueueName string `json:"partitionQueueName,omitempty"`
	// The delay (in seconds) before a partition rebalance is started once needed. Available since (will be released in next SEMP version).
	PartitionRebalanceDelay int64 `json:"partitionRebalanceDelay,omitempty"`
	// The maximum time (in seconds) to wait before handing off a partition while rebalancing. Available since (will be released in next SEMP version).
	PartitionRebalanceMaxHandoffTime int64 `json:"partitionRebalanceMaxHandoffTime,omitempty"`
	...
	PartitionRebalanceStatus string `json:"partitionRebalanceStatus,omitempty"`
	...
	PartitionScaleStatus string `json:"partitionScaleStatus,omitempty"`
	// The status of the partition of the partitioned queue. Only relevant for queues implementing an individual partition. The allowed values and their meaning are:  <pre> \"unassigned\" - Partition is not assigned to a client. \"ready\" - Partition is assigned to a client. \"paused\" - Partition is being handed off to another client. \"unbound\" - Assigned client is not bound. </pre>  Available since (will be released in next SEMP version).
	PartitionStatus string `json:"partitionStatus,omitempty"`
	...
	RedeliveryDelayInitialInterval int32 `json:"redeliveryDelayInitialInterval,omitempty"`
	...
	RedeliveryDelayMaxInterval int32 `json:"redeliveryDelayMaxInterval,omitempty"`
	...
	// The number of guaranteed messages discarded by the Queue due to XA Transactions not being supported. Available since (will be released in next SEMP version).
	XaTransactionNotSupportedDiscardedMsgCount int64 `json:"xaTransactionNotSupportedDiscardedMsgCount,omitempty"`
}
