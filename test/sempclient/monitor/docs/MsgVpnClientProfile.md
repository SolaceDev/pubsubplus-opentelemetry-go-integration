...
------------ | ------------- | ------------- | -------------
**AllowBridgeConnectionsEnabled** | [****bool**](*bool.md) | Indicates whether Bridge clients using the Client Profile are allowed to connect. | [optional] [default to null]
**AllowCutThroughForwardingEnabled** | [****bool**](*bool.md) | Indicates whether clients using the Client Profile are allowed to bind to endpoints with the cut-through forwarding delivery mode. Deprecated since 2.22. This attribute has been deprecated. Please visit the Solace Product Lifecycle Policy web page for details on deprecated features. | [optional] [default to null]
...
**AllowGuaranteedEndpointCreateEnabled** | [****bool**](*bool.md) | Indicates whether clients using the Client Profile are allowed to create topic endponts or queues. | [optional] [default to null]
**AllowGuaranteedMsgReceiveEnabled** | [****bool**](*bool.md) | Indicates whether clients using the Client Profile are allowed to receive guaranteed messages. | [optional] [default to null]
**AllowGuaranteedMsgSendEnabled** | [****bool**](*bool.md) | Indicates whether clients using the Client Profile are allowed to send guaranteed messages. | [optional] [default to null]
**AllowSharedSubscriptionsEnabled** | [****bool**](*bool.md) | Indicates whether shared subscriptions are allowed. Changing this setting does not affect existing subscriptions. | [optional] [default to null]
**AllowTransactedSessionsEnabled** | [****bool**](*bool.md) | Indicates whether clients using the Client Profile are allowed to establish transacted sessions. | [optional] [default to null]
...
**CompressionEnabled** | [****bool**](*bool.md) | Indicates whether clients using the Client Profile are allowed to use compression. | [optional] [default to null]
...
**ElidingEnabled** | [****bool**](*bool.md) | Indicates whether message eliding is enabled for clients using the Client Profile. | [optional] [default to null]
