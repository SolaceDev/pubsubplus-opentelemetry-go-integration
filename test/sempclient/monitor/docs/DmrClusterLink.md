...
**AuthenticationSchemeSecure** | [****bool**](*bool.md) | Indicates whether certificate matching rules are used. Available since 2.28. | [optional] [default to null]
...
**ClientProfileTcpCongestionWindowSize** | **int64** | The TCP initial congestion window size, in multiples of the TCP Maximum Segment Size (MSS). Changing the value from its default of 2 results in non-compliance with RFC 2581. Contact support before changing this value. | [optional] [default to null]
