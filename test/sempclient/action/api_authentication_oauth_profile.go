...
/*
AuthenticationOauthProfileApiService Clear the statistics for the OAuth Profile.
...
*/
func (a *AuthenticationOauthProfileApiService) DoMsgVpnAuthenticationOauthProfileClearStats(ctx context.Context, body MsgVpnAuthenticationOauthProfileClearStats, msgVpnName string, oauthProfileName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
