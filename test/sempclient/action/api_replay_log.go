...
/*
ReplayLogApiService Trim (delete) messages from the Replay Log.
...
*/
func (a *ReplayLogApiService) DoMsgVpnReplayLogTrimLoggedMsgs(ctx context.Context, body MsgVpnReplayLogTrimLoggedMsgs, msgVpnName string, replayLogName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
