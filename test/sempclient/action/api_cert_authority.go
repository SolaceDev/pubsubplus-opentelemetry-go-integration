...
/*
CertAuthorityApiService Refresh the CRL file for the Certificate Authority.
...
*/
func (a *CertAuthorityApiService) DoCertAuthorityRefreshCrl(ctx context.Context, body CertAuthorityRefreshCrl, certAuthorityName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
