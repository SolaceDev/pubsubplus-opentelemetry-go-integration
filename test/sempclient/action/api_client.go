...
/*
ClientApiService Clear an event for the Client so it can be generated anew.
...
*/
func (a *ClientApiService) DoMsgVpnClientClearEvent(ctx context.Context, body MsgVpnClientClearEvent, msgVpnName string, clientName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
...
/*
ClientApiService Clear the statistics for the Client.
...
@return SempMetaOnlyResponse
*/
func (a *ClientApiService) DoMsgVpnClientClearStats(ctx context.Context, body MsgVpnClientClearStats, msgVpnName string, clientName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
ClientApiService Disconnect the Client.
...
@return SempMetaOnlyResponse
*/
func (a *ClientApiService) DoMsgVpnClientDisconnect(ctx context.Context, body MsgVpnClientDisconnect, msgVpnName string, clientName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
ClientApiService Delete the Transacted Session.
...
@return SempMetaOnlyResponse
*/
func (a *ClientApiService) DoMsgVpnClientTransactedSessionDelete(ctx context.Context, body MsgVpnClientTransactedSessionDelete, msgVpnName string, clientName string, sessionName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
