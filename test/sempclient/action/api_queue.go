...
/*
QueueApiService Cancel the replay of messages to the Queue.
...
*/
func (a *QueueApiService) DoMsgVpnQueueCancelReplay(ctx context.Context, body MsgVpnQueueCancelReplay, msgVpnName string, queueName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
...
/*
QueueApiService Clear the statistics for the Queue.
...
@return SempMetaOnlyResponse
*/
func (a *QueueApiService) DoMsgVpnQueueClearStats(ctx context.Context, body MsgVpnQueueClearStats, msgVpnName string, queueName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
QueueApiService Copy a message from another Queue to this Queue.
...
@return SempMetaOnlyResponse
*/
func (a *QueueApiService) DoMsgVpnQueueCopyMsgFromQueue(ctx context.Context, body MsgVpnQueueCopyMsgFromQueue, msgVpnName string, queueName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
QueueApiService Copy a message from a Replay Log to this Queue.
...
@return SempMetaOnlyResponse
*/
func (a *QueueApiService) DoMsgVpnQueueCopyMsgFromReplayLog(ctx context.Context, body MsgVpnQueueCopyMsgFromReplayLog, msgVpnName string, queueName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
QueueApiService Copy a message from a Topic Endpoint to this Queue.
...
@return SempMetaOnlyResponse
*/
func (a *QueueApiService) DoMsgVpnQueueCopyMsgFromTopicEndpoint(ctx context.Context, body MsgVpnQueueCopyMsgFromTopicEndpoint, msgVpnName string, queueName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
QueueApiService Delete all spooled messages from the Queue.
...
@return SempMetaOnlyResponse
*/
func (a *QueueApiService) DoMsgVpnQueueDeleteMsgs(ctx context.Context, body MsgVpnQueueDeleteMsgs, msgVpnName string, queueName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
QueueApiService Delete the Message from the Queue.
...
@return SempMetaOnlyResponse
*/
func (a *QueueApiService) DoMsgVpnQueueMsgDelete(ctx context.Context, body MsgVpnQueueMsgDelete, msgVpnName string, queueName string, msgId string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
QueueApiService Start the replay of messages to the Queue.
...
@return SempMetaOnlyResponse
*/
func (a *QueueApiService) DoMsgVpnQueueStartReplay(ctx context.Context, body MsgVpnQueueStartReplay, msgVpnName string, queueName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
