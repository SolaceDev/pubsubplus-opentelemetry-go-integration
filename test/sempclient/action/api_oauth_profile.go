...
/*
OauthProfileApiService Clear the statistics for the OAuth Profile.
...
*/
func (a *OauthProfileApiService) DoOauthProfileClearStats(ctx context.Context, body OauthProfileClearStats, oauthProfileName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
