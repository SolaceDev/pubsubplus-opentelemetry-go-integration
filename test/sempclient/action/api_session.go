...
/*
SessionApiService Delete the SEMP session.
...
*/
func (a *SessionApiService) DoSessionDelete(ctx context.Context, body SessionDelete, sessionUsername string, sessionId string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
...
/*
SessionApiService Get a SEMP Session object.
...
/*
SessionApiService Get a list of SEMP Session objects.
