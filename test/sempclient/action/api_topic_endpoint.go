...
/*
TopicEndpointApiService Cancel the replay of messages to the Topic Endpoint.
...
*/
func (a *TopicEndpointApiService) DoMsgVpnTopicEndpointCancelReplay(ctx context.Context, body MsgVpnTopicEndpointCancelReplay, msgVpnName string, topicEndpointName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
...
/*
TopicEndpointApiService Clear the statistics for the Topic Endpoint.
...
@return SempMetaOnlyResponse
*/
func (a *TopicEndpointApiService) DoMsgVpnTopicEndpointClearStats(ctx context.Context, body MsgVpnTopicEndpointClearStats, msgVpnName string, topicEndpointName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
TopicEndpointApiService Copy a message from a Queue to this Topic Endpoint.
...
@return SempMetaOnlyResponse
*/
func (a *TopicEndpointApiService) DoMsgVpnTopicEndpointCopyMsgFromQueue(ctx context.Context, body MsgVpnTopicEndpointCopyMsgFromQueue, msgVpnName string, topicEndpointName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
TopicEndpointApiService Copy a message from a Replay Log to this Topic Endpoint.
...
@return SempMetaOnlyResponse
*/
func (a *TopicEndpointApiService) DoMsgVpnTopicEndpointCopyMsgFromReplayLog(ctx context.Context, body MsgVpnTopicEndpointCopyMsgFromReplayLog, msgVpnName string, topicEndpointName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
TopicEndpointApiService Copy a message from another Topic Endpoint to this Topic Endpoint.
...
@return SempMetaOnlyResponse
*/
func (a *TopicEndpointApiService) DoMsgVpnTopicEndpointCopyMsgFromTopicEndpoint(ctx context.Context, body MsgVpnTopicEndpointCopyMsgFromTopicEndpoint, msgVpnName string, topicEndpointName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
TopicEndpointApiService Delete all spooled messages from the Topic Endpoint.
...
@return SempMetaOnlyResponse
*/
func (a *TopicEndpointApiService) DoMsgVpnTopicEndpointDeleteMsgs(ctx context.Context, body MsgVpnTopicEndpointDeleteMsgs, msgVpnName string, topicEndpointName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
TopicEndpointApiService Delete the Message from the Topic Endpoint.
...
@return SempMetaOnlyResponse
*/
func (a *TopicEndpointApiService) DoMsgVpnTopicEndpointMsgDelete(ctx context.Context, body MsgVpnTopicEndpointMsgDelete, msgVpnName string, topicEndpointName string, msgId string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
TopicEndpointApiService Start the replay of messages to the Topic Endpoint.
...
@return SempMetaOnlyResponse
*/
func (a *TopicEndpointApiService) DoMsgVpnTopicEndpointStartReplay(ctx context.Context, body MsgVpnTopicEndpointStartReplay, msgVpnName string, topicEndpointName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
