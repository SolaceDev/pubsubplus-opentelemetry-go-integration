...
/*
ClientCertAuthorityApiService Refresh the CRL file for the Client Certificate Authority.
...
*/
func (a *ClientCertAuthorityApiService) DoClientCertAuthorityRefreshCrl(ctx context.Context, body ClientCertAuthorityRefreshCrl, certAuthorityName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
