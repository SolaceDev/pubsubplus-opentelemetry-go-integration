...
/*
BridgeApiService Clear an event for the Bridge so it can be generated anew.
...
*/
func (a *BridgeApiService) DoMsgVpnBridgeClearEvent(ctx context.Context, body MsgVpnBridgeClearEvent, msgVpnName string, bridgeName string, bridgeVirtualRouter string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
...
/*
BridgeApiService Clear the statistics for the Bridge.
...
@return SempMetaOnlyResponse
*/
func (a *BridgeApiService) DoMsgVpnBridgeClearStats(ctx context.Context, body MsgVpnBridgeClearStats, msgVpnName string, bridgeName string, bridgeVirtualRouter string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
BridgeApiService Disconnect the Bridge.
...
@return SempMetaOnlyResponse
*/
func (a *BridgeApiService) DoMsgVpnBridgeDisconnect(ctx context.Context, body MsgVpnBridgeDisconnect, msgVpnName string, bridgeName string, bridgeVirtualRouter string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
