...
/*
MqttSessionApiService Clear the statistics for the MQTT Session.
...
*/
func (a *MqttSessionApiService) DoMsgVpnMqttSessionClearStats(ctx context.Context, body MsgVpnMqttSessionClearStats, msgVpnName string, mqttSessionClientId string, mqttSessionVirtualRouter string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
