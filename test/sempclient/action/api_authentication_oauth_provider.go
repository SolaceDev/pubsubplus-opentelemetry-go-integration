...
/*
AuthenticationOauthProviderApiService Clear the statistics for the OAuth Provider.
...
*/
func (a *AuthenticationOauthProviderApiService) DoMsgVpnAuthenticationOauthProviderClearStats(ctx context.Context, body MsgVpnAuthenticationOauthProviderClearStats, msgVpnName string, oauthProviderName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
