...
/*
AboutApiService Logout of the current session.
...
*/
func (a *AboutApiService) DoAboutUserLogout(ctx context.Context, body AboutUserLogout) (SempMetaOnlyResponse, *http.Response, error) {
	var (
