...
/*
TransactionApiService Commit the Transaction.
...
*/
func (a *TransactionApiService) DoMsgVpnTransactionCommit(ctx context.Context, body MsgVpnTransactionCommit, msgVpnName string, xid string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
...
/*
TransactionApiService Delete the Transaction.
...
@return SempMetaOnlyResponse
*/
func (a *TransactionApiService) DoMsgVpnTransactionDelete(ctx context.Context, body MsgVpnTransactionDelete, msgVpnName string, xid string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
TransactionApiService Rollback the Transaction.
...
@return SempMetaOnlyResponse
*/
func (a *TransactionApiService) DoMsgVpnTransactionRollback(ctx context.Context, body MsgVpnTransactionRollback, msgVpnName string, xid string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
