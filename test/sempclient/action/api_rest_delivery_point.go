...
/*
RestDeliveryPointApiService Clear the statistics for the REST Consumer.
...
*/
func (a *RestDeliveryPointApiService) DoMsgVpnRestDeliveryPointRestConsumerClearStats(ctx context.Context, body MsgVpnRestDeliveryPointRestConsumerClearStats, msgVpnName string, restDeliveryPointName string, restConsumerName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
