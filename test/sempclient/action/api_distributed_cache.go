...
/*
DistributedCacheApiService Backup cached messages of the Cache Instance to disk.
...
*/
func (a *DistributedCacheApiService) DoMsgVpnDistributedCacheClusterInstanceBackupCachedMsgs(ctx context.Context, body MsgVpnDistributedCacheClusterInstanceBackupCachedMsgs, msgVpnName string, cacheName string, clusterName string, instanceName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
...
/*
DistributedCacheApiService Cancel the backup of cached messages from the Cache Instance.
...
@return SempMetaOnlyResponse
*/
func (a *DistributedCacheApiService) DoMsgVpnDistributedCacheClusterInstanceCancelBackupCachedMsgs(ctx context.Context, body MsgVpnDistributedCacheClusterInstanceCancelBackupCachedMsgs, msgVpnName string, cacheName string, clusterName string, instanceName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
DistributedCacheApiService Cancel the restore of cached messages to the Cache Instance.
...
@return SempMetaOnlyResponse
*/
func (a *DistributedCacheApiService) DoMsgVpnDistributedCacheClusterInstanceCancelRestoreCachedMsgs(ctx context.Context, body MsgVpnDistributedCacheClusterInstanceCancelRestoreCachedMsgs, msgVpnName string, cacheName string, clusterName string, instanceName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
DistributedCacheApiService Clear an event for the Cache Instance so it can be generated anew.
...
@return SempMetaOnlyResponse
*/
func (a *DistributedCacheApiService) DoMsgVpnDistributedCacheClusterInstanceClearEvent(ctx context.Context, body MsgVpnDistributedCacheClusterInstanceClearEvent, msgVpnName string, cacheName string, clusterName string, instanceName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
DistributedCacheApiService Clear the statistics for the Cache Instance.
...
@return SempMetaOnlyResponse
*/
func (a *DistributedCacheApiService) DoMsgVpnDistributedCacheClusterInstanceClearStats(ctx context.Context, body MsgVpnDistributedCacheClusterInstanceClearStats, msgVpnName string, cacheName string, clusterName string, instanceName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
DistributedCacheApiService Delete messages covered by the given topic in the Cache Instance.
...
@return SempMetaOnlyResponse
*/
func (a *DistributedCacheApiService) DoMsgVpnDistributedCacheClusterInstanceDeleteMsgs(ctx context.Context, body MsgVpnDistributedCacheClusterInstanceDeleteMsgs, msgVpnName string, cacheName string, clusterName string, instanceName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
DistributedCacheApiService Restore cached messages for the Cache Instance from disk.
...
@return SempMetaOnlyResponse
*/
func (a *DistributedCacheApiService) DoMsgVpnDistributedCacheClusterInstanceRestoreCachedMsgs(ctx context.Context, body MsgVpnDistributedCacheClusterInstanceRestoreCachedMsgs, msgVpnName string, cacheName string, clusterName string, instanceName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
DistributedCacheApiService Start the Cache Instance.
...
@return SempMetaOnlyResponse
*/
func (a *DistributedCacheApiService) DoMsgVpnDistributedCacheClusterInstanceStart(ctx context.Context, body MsgVpnDistributedCacheClusterInstanceStart, msgVpnName string, cacheName string, clusterName string, instanceName string) (SempMetaOnlyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
